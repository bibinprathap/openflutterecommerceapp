  ...
  ThemeData appBarTheme(BuildContext context) {
    ...
    return theme.copyWith(
        ...
        textTheme: theme.textTheme.copyWith(
            title: theme.textTheme.body2
                .copyWith(color: theme.primaryTextTheme.body2.color ,fontSize:14)  ));
  }
  @override
      ...
      builder: (ctx, datas) {
        if (datas.data != null)
          ...
          children: datas.data.hits.map((data) {
            String BASE64_STRING = data.data['imagepath'].replaceAll('data:image/jpeg;base64,', '');
            ...
            Uint8List bytes = data.data['imagepath'].indexOf('data:image/jpeg;base64,') > -1  ?  base64Decode(BASE64_STRING):null;
            final ImageProvider image= data.data['imagepath'].indexOf('data:image/jpeg;base64,') > -1  ? MemoryImage(bytes) : NetworkImage(data.data['imagepath']);
            return  InkWell(
                onTap: (){
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                        ...
                        child:  Column(
                            ...
                            children: <Widget>[Text(data.data['descr'],
